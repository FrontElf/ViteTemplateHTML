...
const ignoredDirs = ['vendor', 'node_modules', 'template_plugins', 'dist', '.git', 'fonts-converter']
...
export default defineConfig({
  ...
  plugins: [
    ...
    ...((isProduction && templateConfig.imgQuality.generateWebP) ? [modules.vitePluginImageOptimizer(templateConfig.imgQuality),] : []),
