...
class ScrollAnimations {
   ...
   initParallaxSection() {
      ...
      this.mm.add("(min-width: 1280.98px)", () => {
         ...
         tl.to(phoneImage, { x: '0%', opacity: 1 })
            ...
            .to(section_02, { opacity: 1, y: this.getVH(0), duration: 1, ease: "back.out(1.1)" }, "<")
            .to(dirtyChirtImage, { x: "42vw", y: this.getVH(-10), duration: 1, ease: "back.out(1.1)" }, "<")
            .to(bagImage, { x: '0vw', opacity: 1, duration: 1, ease: "back.out(1.1)" }, "+=0.1")
            ...
            .to(section_03, { opacity: 1, y: this.getVH(0), duration: 1 }, "<")
            ...
            .to(section_04, { opacity: 1, y: this.getVH(0), duration: 1 }, "<")
            .to(cleanChirtImage, { opacity: 1, y: this.getVH(0), duration: 1 })
      ...
      this.mm.add("(max-width: 767.98px) and (min-width: 619.98px)", () => {
         ...
         tl.to(phoneImage, { x: '0%', opacity: 1 })
            ...
            .to(section_02, { opacity: 1, y: this.getVH(0), duration: 1 }, "<")
            ...
            .to(busImage_2, { x: '0%', opacity: 1, duration: 1 }, "+=0.1")
            .to(sectionHeader_04, { '--before-opacity': 1, duration: 1 }, "<")
            .to(cleanChirtImage, { x: "22vw", y: this.getVH(-8), scale: 0.3, filter: "brightness(0.9)", duration: 1 }, "<")
            .to({}, { duration: 1 })
      ...
      this.mm.add("(max-width: 619.98px) and (min-width: 479.98px)", () => {
         ...
         tl.to(phoneImage, { x: '0%', opacity: 1 })
            ...
            .to(busImage_2, { x: '0%', opacity: 1, duration: 1 }, "+=0.1")
            .to(sectionHeader_04, { '--before-opacity': 1, duration: 1 }, "<")
            .to(cleanChirtImage, { x: "24vw", y: this.getVH(-12), scale: 0.28, filter: "brightness(0.9)", duration: 1 }, "<")
            .to({}, { duration: 1 })
      ...
      this.mm.add("(max-width: 479.98px)", () => {
         ...
         tl.to(phoneImage, { x: '0%', opacity: 1 }, "+=0.2")
            ...
            .to(bagImage, { x: "8vw", y: this.getVH(-35), rotate: -12, scale: 0.4, filter: "brightness(0.8) contrast(1.2)", duration: 1 }, "+=0.1")
            .to(scrollTopArray_02, { y: this.getVH(-100), duration: 1 })
            .to(bagImage, { y: this.getVH(-140), duration: 1 }, "<")
            .to(section_03, { opacity: 1, y: this.getVH(0), duration: 1 }, "<")
            .to(dryerVideo, { opacity: 1, y: 0, duration: 1 }, "<")
            .to(dryerVideoEl, { scale: 1, height: this.getVH(100), margin: 0, borderRadius: 0, duration: 1 })
            .to(sectionHeader_03, { '--before-opacity': 1, duration: 1 }, "<")
            ...
            .to(busImage_2, { x: '0%', opacity: 1, duration: 1 }, "+=0.1")
            .to(sectionHeader_04, { '--before-opacity': 1, duration: 1 }, "<")
            .to(cleanChirtImage, { x: "28vw", y: this.getVH(-20), scale: 0.28, filter: "brightness(0.9)", duration: 1 }, "<")
            .to({}, { duration: 1 })
   ...
   scrollToTarget(el) {
      ...
      const scrollTarget = (pinnedTrigger && typeof pinnedTrigger.start === 'number')
         ? pinnedTrigger.start
         : el
      ...
      const top = typeof scrollTarget === 'number'
         ? scrollTarget - offset
