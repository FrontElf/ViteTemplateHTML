import { getHash, setHash, _slideUp, _slideDown, dataMediaQueries } from '../scripts/functions.js'
      ...
      blocks.forEach(({ item }) => {
         ...
         contents.forEach((content, i) => {
            ...
            if (media.matches) {
               ...
               item.classList.add(this.config.classSpoiler)
            } else {
               content.before(titles[i])
               item.classList.remove(this.config.classSpoiler)
            }
         })
      })
   }
